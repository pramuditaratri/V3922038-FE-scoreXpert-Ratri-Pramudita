...
import 'package:flutter_application_1/screen/history.dart';
 // Sesuaikan dengan lokasi ProfileScreen
...
class _DashboardScreenState extends State<DashboardScreen> {
 ...
 void _onItemTapped(int index) {
  ...
  if (index == 1) { // Tab ke-2 (Riwayat)
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => HistoryScreen(), // Ganti dengan halaman riwayat
      ),
    );
  } else if (index == 2) { // Tab ke-3 (Profil)
    Navigator.push(
      context,
      MaterialPageRoute(
